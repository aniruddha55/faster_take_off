...
function actRwyArrTime = sampleErlstRwyTime(index, flight_trajectory, engine, engine_data)
...
actMergeNodeTime_current = flight_trajectory.actMergeNodeArrTime(index);
N = 14; 
timeBin_size = 1;
