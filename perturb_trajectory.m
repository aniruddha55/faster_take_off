...
if (current_time > table_of_factors_data.actRwyRelTime(index))
    ...
    abs(flight_trajectory.actRwyRelTime(index) - table_of_factors_data.actRwyRelTime(index))
    
    if abs(flight_trajectory.actRwyRelTime(index) - table_of_factors_data.actRwyRelTime(index)) > 12
        table_of_factors_data.actRwyRelTime(index)
        flight_trajectory.actRwyRelTime(index)
